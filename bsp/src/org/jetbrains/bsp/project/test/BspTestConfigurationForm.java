...
public class BspTestConfigurationForm extends SettingsEditor<BspTestRunConfiguration> {
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadLabelText$$$(label1, ResourceBundle.getBundle("messages/ScalaBspBundle").getString("bsp.test.kind"));
        ...
        this.$$$loadLabelText$$$(label2, ResourceBundle.getBundle("messages/ScalaBspBundle").getString("bsp.test.classes.regex"));
        ...
        this.$$$loadLabelText$$$(label3, ResourceBundle.getBundle("messages/ScalaBspBundle").getString("bsp.test.matched.classes"));
        ...
        this.$$$loadButtonText$$$(refreshClassesButton, ResourceBundle.getBundle("messages/ScalaBspBundle").getString("bsp.test.refresh"));
