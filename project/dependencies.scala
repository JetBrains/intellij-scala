...
object Dependencies {
  ...
  val fastparse: ModuleID = "com.lihaoyi" % s"fastparse_$scalaBinaryVersion" % "1.0.0" // transitive dependency of scalaMeta, needs explicit versioning
