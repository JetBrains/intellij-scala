...
object Dependencies {
  ...
  val scalaMetaCore: ModuleID = "org.scalameta" % "scalameta_2.11" % "0.1.0-SNAPSHOT" withSources()
  val scalaMetaInterpreter: ModuleID = "org.scalameta" %% "interpreter" % "0.1.0-SNAPSHOT" withSources()
