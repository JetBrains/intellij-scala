...
Reproduces the ABI of [scala.tasty.Reflection.scala](https://github.com/lampepfl/dotty/blob/0.27.0-RC1/library/src/scala/tasty/Reflection.scala) (and several related Scala classes).
