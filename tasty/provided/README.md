...
Reproduces the ABI of [scala.tasty.Reflection.scala](https://github.com/lampepfl/dotty/blob/M2/library/src/scala/quoted/Quotes.scala) (and several related Scala classes).
