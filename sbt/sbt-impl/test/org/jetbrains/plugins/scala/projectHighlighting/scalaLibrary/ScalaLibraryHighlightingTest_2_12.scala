...
class ScalaLibraryHighlightingTest_2_12 extends ScalaLibraryHighlightingTest {
  ...
  override protected def filesWithProblems: Map[String, Set[TextRange]] = Map(
    "scala/Predef.scala" -> Set(
      ...
      (20466,20482), // Pattern type is incompatible with expected type, found: Array[AnyRef], required: Array[T]
      (20519,20536), // Pattern type is incompatible with expected type, found: Array[Boolean], required: Array[T]
      (20568,20582), // Pattern type is incompatible with expected type, found: Array[Byte], required: Array[T]
      (20614,20628), // Pattern type is incompatible with expected type, found: Array[Char], required: Array[T]
      (20660,20676), // Pattern type is incompatible with expected type, found: Array[Double], required: Array[T]
      (20708,20723), // Pattern type is incompatible with expected type, found: Array[Float], required: Array[T]
      (20755,20768), // Pattern type is incompatible with expected type, found: Array[Int], required: Array[T]
      (20800,20814), // Pattern type is incompatible with expected type, found: Array[Long], required: Array[T]
      (20846,20861), // Pattern type is incompatible with expected type, found: Array[Short], required: Array[T]
      (20893,20907), // Pattern type is incompatible with expected type, found: Array[Unit], required: Array[T]
    ),
    ...
    "scala/util/Sorting.scala" -> Set(
      ...
      (8827,8840), // Pattern type is incompatible with expected type, found: Array[Int], required: Array[T]
      (8934,8937), // Type mismatch, expected: Ordering[Int], actual: Ordering[T]
      (8948,8964), // Pattern type is incompatible with expected type, found: Array[Double], required: Array[T]
      (9003,9006), // Type mismatch, expected: Ordering[Double], actual: Ordering[T]
      (9082,9096), // Pattern type is incompatible with expected type, found: Array[Long], required: Array[T]
      (9191,9194), // Type mismatch, expected: Ordering[Long], actual: Ordering[T]
      (9205,9220), // Pattern type is incompatible with expected type, found: Array[Float], required: Array[T]
      (9259,9262), // Type mismatch, expected: Ordering[Float], actual: Ordering[T]
      (9339,9353), // Pattern type is incompatible with expected type, found: Array[Char], required: Array[T]
      (9448,9451), // Type mismatch, expected: Ordering[Char], actual: Ordering[T]
      (9462,9476), // Pattern type is incompatible with expected type, found: Array[Byte], required: Array[T]
      (9571,9574), // Type mismatch, expected: Ordering[Byte], actual: Ordering[T]
      (9585,9600), // Pattern type is incompatible with expected type, found: Array[Short], required: Array[T]
      (9696,9699), // Type mismatch, expected: Ordering[Short], actual: Ordering[T]
      (9710,9727), // Pattern type is incompatible with expected type, found: Array[Boolean], required: Array[T]
