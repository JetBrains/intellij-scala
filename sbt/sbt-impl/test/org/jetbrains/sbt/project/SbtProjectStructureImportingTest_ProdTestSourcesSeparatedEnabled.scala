...
final class SbtProjectStructureImportingTest_ProdTestSourcesSeparatedEnabled extends SbtProjectStructureImportingLike {
      ...
      new project(projectName) {
        ...
        modules := Seq(
          new module(projectName) {
            contentRoots += projectPath
            excluded := Seq("target")
          },
          new module(s"$projectName.main") {
            contentRoots := Seq(s"$projectPath/src/main", s"$projectPath/target/scala-$scalaVersion/src_managed/main", s"$projectPath/target/scala-$scalaVersion/resource_managed/main")
          ...
          new module(s"$projectName.test") {
            contentRoots := Seq(s"$projectPath/src/test", s"$projectPath/target/scala-$scalaVersion/src_managed/test", s"$projectPath/target/scala-$scalaVersion/resource_managed/test")
      ...
      new project(ideProjectName) {
        ...
        modules := Seq(
          ...
          new module(s"$originalProjectName.main") {
            contentRoots := Seq(s"$projectPath/src/main", s"$projectPath/target/scala-2.13/src_managed/main", s"$projectPath/target/scala-2.13/resource_managed/main")
            ProjectStructureDsl.sources := Seq("scala", "java")
            resources := Seq("resources")
            libraryDependencies := expectedScalaLibraries
          },
          new module(s"$originalProjectName.test") {
            contentRoots := Seq(s"$projectPath/src/test", s"$projectPath/target/scala-2.13/src_managed/test", s"$projectPath/target/scala-2.13/resource_managed/test")
            testSources := Seq("scala", "java")
            testResources := Seq("resources")
            libraryDependencies := expectedScalaLibraries
          },
  ...
  private def assertDirectoryCompletionVariantsForProjectPaths(
    ...
    projectPaths.foreach { projectPath =>
      Seq(
        (projectPath, expectedSbtCompletionVariants),
      ...
      ).foreach{ case(path, variants) => assertSbtDirectoryCompletionContributorVariants(findVirtualFile(path), variants)}
    }
  }

  private def findVirtualFile(projectPath: String): VirtualFile = {
    val vfm = VirtualFileManager.getInstance()
    val linkedProjectBaseDir = vfm.findFileByNioPath(Path.of(projectPath))
    Assert.assertNotNull(linkedProjectBaseDir)
    linkedProjectBaseDir
  }
  ...
  def testMultiModule(): Unit = runTest(
    new project("multiModule") {
      ...
      lazy val fooTest = new module("multiModule.foo.test")
  ...
  def testUnmanagedDependency(): Unit = runTest(
    new project("unmanagedDependency") {
      ...
      val unmanagedDependencyMain: module = new module("unmanagedDependency.main") {
        libraries := Seq(unmanagedLibrary)
        libraryDependencies := myLibraryDependencies
      }
      val unmanagedDependencyTest: module = new module("unmanagedDependency.test") {
        libraries := Seq(unmanagedLibrary)
        libraryDependencies := myLibraryDependencies
      }
      modules := Seq(
  ...
  def testSCL13600(): Unit = runTest(
    new project("root") {
      ...
      val modulesFromRoot: Seq[module] = Seq(
        ...
        new module("project1InRootBuild.main", Array("root")),
        new module("project1InRootBuild.test", Array("root")),
        new module("project2InRootBuild", Array("root")),
        new module("project2InRootBuild.main", Array("root")),
        new module("project2InRootBuild.test", Array("root")),
        new module("project3InRootBuildWithSameName", Array("root", "same name in root build")),
        new module("project3InRootBuildWithSameName.main", Array("root", "same name in root build")),
        new module("project3InRootBuildWithSameName.test", Array("root", "same name in root build")),
        new module("project4InRootBuildWithSameName", Array("root", "same name in root build")),
        new module("project4InRootBuildWithSameName.main", Array("root", "same name in root build")),
        new module("project4InRootBuildWithSameName.test", Array("root", "same name in root build")),
        new module("project5InRootBuildWithSameGlobalName", Array("root", "same global name")),
        new module("project5InRootBuildWithSameGlobalName.main", Array("root", "same global name")),
        new module("project5InRootBuildWithSameGlobalName.test", Array("root", "same global name")),
        new module("project6InRootBuildWithSameGlobalName", Array("root", "same global name")),
        new module("project6InRootBuildWithSameGlobalName.main", Array("root", "same global name")),
        new module("project6InRootBuildWithSameGlobalName.test", Array("root", "same global name")),
      )
      val modulesFromC1: Seq[module] = Seq(
        rootC1,rootC1Main, rootC1Test,
        new module("project1InC1", Array("Build C1 Name")),
        new module("project1InC1.main", Array("Build C1 Name")),
        new module("project1InC1.test", Array("Build C1 Name")),
        new module("project2InC1", Array("Build C1 Name")),
        new module("project2InC1.main", Array("Build C1 Name")),
        new module("project2InC1.test", Array("Build C1 Name")),
        new module("project3InC1WithSameName", Array("Build C1 Name", "same name in c1")),
        new module("project3InC1WithSameName.main", Array("Build C1 Name", "same name in c1")),
        new module("project3InC1WithSameName.test", Array("Build C1 Name", "same name in c1")),
        new module("project4InC1WithSameName", Array("Build C1 Name", "same name in c1")),
        new module("project4InC1WithSameName.main", Array("Build C1 Name", "same name in c1")),
        new module("project4InC1WithSameName.test", Array("Build C1 Name", "same name in c1")),
        new module("project5InC1WithSameGlobalName", Array("Build C1 Name", "same global name")),
        new module("project5InC1WithSameGlobalName.main", Array("Build C1 Name", "same global name")),
        new module("project5InC1WithSameGlobalName.test", Array("Build C1 Name", "same global name")),
        new module("project6InC1WithSameGlobalName", Array("Build C1 Name", "same global name")),
        new module("project6InC1WithSameGlobalName.main", Array("Build C1 Name", "same global name")),
        new module("project6InC1WithSameGlobalName.test", Array("Build C1 Name", "same global name")),
      )
      val modulesFromC2: Seq[module] = Seq(
        rootC2, rootC2Main, rootC2Test,
        new module("project1InC2", Array("Build C2 Name")),
        new module("project1InC2.main", Array("Build C2 Name")),
        new module("project1InC2.test", Array("Build C2 Name")),
        new module("project2InC2", Array("Build C2 Name")),
        new module("project2InC2.main", Array("Build C2 Name")),
        new module("project2InC2.test", Array("Build C2 Name")),
        new module("project3InC2WithSameName", Array("Build C2 Name", "same name in c2")),
        new module("project3InC2WithSameName.main", Array("Build C2 Name", "same name in c2")),
        new module("project3InC2WithSameName.test", Array("Build C2 Name", "same name in c2")),
        new module("project4InC2WithSameName", Array("Build C2 Name", "same name in c2")),
        new module("project4InC2WithSameName.main", Array("Build C2 Name", "same name in c2")),
        new module("project4InC2WithSameName.test", Array("Build C2 Name", "same name in c2")),
        new module("project5InC2WithSameGlobalName", Array("Build C2 Name", "same global name")),
        new module("project5InC2WithSameGlobalName.main", Array("Build C2 Name", "same global name")),
        new module("project5InC2WithSameGlobalName.test", Array("Build C2 Name", "same global name")),
        new module("project6InC2WithSameGlobalName", Array("Build C2 Name", "same global name")),
        new module("project6InC2WithSameGlobalName.main", Array("Build C2 Name", "same global name")),
        new module("project6InC2WithSameGlobalName.test", Array("Build C2 Name", "same global name")),
      )
      val modulesFromC3: Seq[module] = Seq(
        rootC3, rootC3Main, rootC3Test,
        new module("project1InC3", Array("root~1")),
        new module("project1InC3.main", Array("root~1")),
        new module("project1InC3.test", Array("root~1")),
        new module("project2InC3", Array("root~1")),
        new module("project2InC3.main", Array("root~1")),
        new module("project2InC3.test", Array("root~1")),
        new module("project3InC3WithSameName", Array("root~1", "same name in c3")),
        new module("project3InC3WithSameName.main", Array("root~1", "same name in c3")),
        new module("project3InC3WithSameName.test", Array("root~1", "same name in c3")),
        new module("project4InC3WithSameName", Array("root~1", "same name in c3")),
        new module("project4InC3WithSameName.main", Array("root~1", "same name in c3")),
        new module("project4InC3WithSameName.test", Array("root~1", "same name in c3")),
        new module("project5InC3WithSameGlobalName", Array("root~1", "same global name")),
        new module("project5InC3WithSameGlobalName.main", Array("root~1", "same global name")),
        new module("project5InC3WithSameGlobalName.test", Array("root~1", "same global name")),
        new module("project6InC3WithSameGlobalName", Array("root~1", "same global name")),
        new module("project6InC3WithSameGlobalName.main", Array("root~1", "same global name")),
        new module("project6InC3WithSameGlobalName.test", Array("root~1", "same global name")),
      )
      val modulesFromC4: Seq[module] = Seq(
        rootC4, rootC4Main, rootC4Test,
        new module("project1InC4", Array("root~2")),
        new module("project1InC4.main", Array("root~2")),
        new module("project1InC4.test", Array("root~2")),
        new module("project2InC4", Array("root~2")),
        new module("project2InC4.main", Array("root~2")),
        new module("project2InC4.test", Array("root~2")),
        new module("project3InC4WithSameName", Array("root~2", "same name in c4")),
        new module("project3InC4WithSameName.main", Array("root~2", "same name in c4")),
        new module("project3InC4WithSameName.test", Array("root~2", "same name in c4")),
        new module("project4InC4WithSameName", Array("root~2", "same name in c4")),
        new module("project4InC4WithSameName.main", Array("root~2", "same name in c4")),
        new module("project4InC4WithSameName.test", Array("root~2", "same name in c4")),
        new module("project5InC4WithSameGlobalName", Array("root~2", "same global name")),
        new module("project5InC4WithSameGlobalName.main", Array("root~2", "same global name")),
        new module("project5InC4WithSameGlobalName.test", Array("root~2", "same global name")),
        new module("project6InC4WithSameGlobalName", Array("root~2", "same global name")),
        new module("project6InC4WithSameGlobalName.main", Array("root~2", "same global name")),
        new module("project6InC4WithSameGlobalName.test", Array("root~2", "same global name")),
      )
  ...
  def testSCL14635(): Unit = runTest(
    new project("SCL-14635") {
      ...
      modules := Seq(
        ...
        new module("sbt-idea-plugin.main", sbtIdeaPluginGroup),
        new module("sbt-idea-plugin.test", sbtIdeaPluginGroup),
        new module("sbt-declarative-core", sbtIdeaPluginGroup),
        new module("sbt-declarative-core.main", sbtIdeaPluginGroup),
        new module("sbt-declarative-core.test", sbtIdeaPluginGroup),
        new module("sbt-declarative-packaging", sbtIdeaPluginGroup),
        new module("sbt-declarative-packaging.main", sbtIdeaPluginGroup),
        new module("sbt-declarative-packaging.test", sbtIdeaPluginGroup),
        new module("sbt-declarative-visualizer", sbtIdeaPluginGroup),
        new module("sbt-declarative-visualizer.main", sbtIdeaPluginGroup),
        new module("sbt-declarative-visualizer.test", sbtIdeaPluginGroup),
  ...
  def testCrossplatform(): Unit = runTest(
    new project("crossplatform") {
      ...
      lazy val rootMain = new module("crossplatform.main")
      lazy val rootTest = new module("crossplatform.test")
      lazy val crossJS = new module("crossJS.main", Array("crossplatform", "cross"))
      lazy val crossJSMain = new module("crossJS.test", Array("crossplatform", "cross"))
      lazy val crossJSTest = new module("crossJS", Array("crossplatform", "cross"))
      lazy val crossJVM = new module("crossJVM", Array("crossplatform", "cross"))
      lazy val crossJVMMain = new module("crossJVM.main", Array("crossplatform", "cross"))
      lazy val crossJVMTest = new module("crossJVM.test", Array("crossplatform", "cross"))
      lazy val crossNative = new module("crossNative", Array("crossplatform", "cross"))
      lazy val crossNativeMain = new module("crossNative.main", Array("crossplatform", "cross"))
      lazy val crossNativeTest = new module("crossNative.test", Array("crossplatform", "cross"))
      lazy val crossSources = new module("cross-sources", Array("crossplatform", "cross"))
      lazy val crossSourcesMain = new module("cross-sources.main", Array("crossplatform", "cross"))
      lazy val crossSourcesTest = new module("cross-sources.test", Array("crossplatform", "cross"))
      lazy val jsJvmSources = new module("js-jvm-sources", Array("crossplatform", "cross"))
      lazy val jsJvmSourcesMain = new module("js-jvm-sources.main", Array("crossplatform", "cross"))
      lazy val jsJvmSourcesTest = new module("js-jvm-sources.test", Array("crossplatform", "cross"))
      lazy val jsNativeSources = new module("js-native-sources", Array("crossplatform", "cross"))
      lazy val jsNativeSourcesMain = new module("js-native-sources.main", Array("crossplatform", "cross"))
      lazy val jsNativeSourcesTest = new module("js-native-sources.test", Array("crossplatform", "cross"))
      lazy val jvmNativeSources = new module("jvm-native-sources", Array("crossplatform", "cross"))
      lazy val jvmNativeSourcesMain = new module("jvm-native-sources.main", Array("crossplatform", "cross"))
      lazy val jvmNativeSourcesTest = new module("jvm-native-sources.test", Array("crossplatform", "cross"))

      modules := Seq(
        root, rootMain, rootTest,
        crossJS, crossJSMain, crossJSTest,
        crossJVM, crossJVMMain, crossJVMTest,
        crossNative, crossNativeMain, crossNativeTest,
        crossSources, crossSourcesMain, crossSourcesTest,
        jsJvmSources, jsJvmSourcesMain, jsJvmSourcesTest,
        jsNativeSources, jsNativeSourcesMain, jsNativeSourcesTest,
        jvmNativeSources, jvmNativeSourcesMain, jvmNativeSourcesTest
      )
    }
  )
  ...
  def testProjectWithModulesWithSameIdsAndNamesWithDifferentCase(): Unit = runTest(
    new project("sameIdsAndNamesWithDifferentCase") {
      val plainModules: Seq[module] = Seq(
      ...
      val modulesEnrichedByMainTestModules: Seq[module] = plainModules.flatMap { module =>
        val moduleName = module.name
        Seq(new module (s"$moduleName.main"), new module (s"$moduleName.test")) :+ module
      }
      modules := modulesEnrichedByMainTestModules
    }
  )
  ...
  def testMultiBuildProjectWithSpecialCharactersInRootProjectNames(): Unit = runTest(
    new project("ro//o.t.") {
      ...
      val modulesRoot: Seq[module] = Seq(
        ...
        new module("project1.main", Array("ro__o_t_")),
        new module("project1.test", Array("ro__o_t_")),
      )
      val modulesC1: Seq[module] = Seq(
        rootC1, rootC1Main, rootC1Test,
        new module("project1", Array("Build__1_N_ame")),
        new module("project1.main", Array("Build__1_N_ame")),
        new module("project1.test", Array("Build__1_N_ame")),
      )
