...
public class SbtRunConfigurationForm {
    ...
    private void createUIComponents() {
        ...
        tasksPanel = UI.PanelFactory.panel(tasksEditor)
                .withComment(SbtBundle.message("sbt.runner.form.tasks.comment"))
                .createPanel();
    }
    ...
    private void $$$setupUI$$$() {
        ...
        mainPanel.add(tasksPanel, new GridConstraints(1, 0, 1, 2, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, new Dimension(495, -1), null, 0, false));
