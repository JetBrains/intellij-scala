...
interface SharedSourcesOwnersEntityBuilder : WorkspaceEntityBuilder<SharedSourcesOwnersEntity>,
    ModuleExtensionWorkspaceEntityBuilder<SharedSourcesOwnersEntity> {
    override var entitySource: EntitySource
    override var module: ModuleEntityBuilder
    var ownerModuleIds: MutableList<String>
}

internal object SharedSourcesOwnersEntityType :
    EntityType<SharedSourcesOwnersEntity, SharedSourcesOwnersEntityBuilder>() {
