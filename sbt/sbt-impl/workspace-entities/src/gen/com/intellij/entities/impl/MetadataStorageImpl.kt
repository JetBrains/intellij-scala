...
internal object MetadataStorageImpl : MetadataStorageBase() {
    override fun initializeMetadata() {
        ...
        typeMetadata = FinalClassMetadata.ClassMetadata(
            fqName = "com.intellij.entities.SbtEntitySource",
            properties = listOf(
                OwnPropertyMetadata(
                    isComputable = false,
                    isKey = false,
        ...
        typeMetadata = FinalClassMetadata.ObjectMetadata(
            fqName = "com.intellij.entities.SharedSourcesOwnersEntitySource",
            properties = listOf(
                OwnPropertyMetadata(
                    isComputable = false,
                    isKey = false,
        ...
        typeMetadata = EntityMetadata(
            fqName = "com.intellij.entities.ModuleExtensionWorkspaceEntity",
            entityDataFqName = "com.intellij.entities.impl.ModuleExtensionWorkspaceEntityData",
            ...
            properties = listOf(
                ...
                OwnPropertyMetadata(
                    ...
                    valueType = ValueTypeMetadata.EntityReference(
                        connectionType = ConnectionId.ConnectionType.ABSTRACT_ONE_TO_ONE,
            ...
            extProperties = listOf(
                ExtPropertyMetadata(
                    isComputable = false,
                    isOpen = false,
                    name = "moduleExtensionWorkspaceEntity",
                    receiverFqn = "com.intellij.platform.workspace.jps.entities.ModuleEntity",
                    valueType = ValueTypeMetadata.EntityReference(
                        connectionType = ConnectionId.ConnectionType.ABSTRACT_ONE_TO_ONE,
                        entityFqName = "com.intellij.entities.ModuleExtensionWorkspaceEntity",
                        isChild = true,
                        isNullable = false
                    ),
                    withDefault = false
        ...
        typeMetadata = EntityMetadata(
            fqName = "com.intellij.entities.SbtModuleEntity",
            entityDataFqName = "com.intellij.entities.impl.SbtModuleEntityData",
            supertypes = listOf(
                "com.intellij.platform.workspace.storage.WorkspaceEntity",
                "com.intellij.entities.ModuleExtensionWorkspaceEntity"
            ),
            properties = listOf(
                OwnPropertyMetadata(
                    isComputable = false,
        ...
        typeMetadata = EntityMetadata(
            fqName = "com.intellij.entities.SharedSourcesOwnersEntity",
            entityDataFqName = "com.intellij.entities.impl.SharedSourcesOwnersEntityData",
            supertypes = listOf(
                "com.intellij.platform.workspace.storage.WorkspaceEntity",
                "com.intellij.entities.ModuleExtensionWorkspaceEntity"
            ),
