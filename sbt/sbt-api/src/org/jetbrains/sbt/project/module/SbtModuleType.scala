...
class SbtModuleType extends ModuleType[DummyModuleBuilder](Id) {
  ...
  override def getName: String = SbtApiBundle.message("sbt.build.module.name")

  override def getDescription: String = SbtApiBundle.message("sbt.build.module.description")
