 ...
 * Main and test modules might be located both inside ModuleData modules (cause root project inside each build also contains sources and test) and SbtNestedModuleData modules.
