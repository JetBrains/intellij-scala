...
//        }
//        while (!args.isEmpty()) {
//          scala.collection.immutable.List argsBuf = args;
//          if (((String) args.head()).startsWith("-")) {
//            scala.collection.immutable.List settings = allSettings();
