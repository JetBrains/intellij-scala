...
// temporary fix for SCL-1785
// todo update BackendCompilerWrapper in IntelliJ to allow the encoding to be specified.
public class EncodingAwareBackendCompilerWrapper {
  ...
  public EncodingAwareBackendCompilerWrapper(Chunk<Module> chunk, @NotNull final Project project,
  ...
  final static class CompiledClass {
  ...
  private class SynchedCompilerParsing extends EncodingAwareCompilerParsingThread {
    ...
    private SynchedCompilerParsing(Process process,
                                  ...
                                  boolean trimLines) {
      super(process, outputParser, readErrorStream, trimLines,context, encoding);
  ...
  private void doCompile(@NotNull final ModuleChunk chunk, @NotNull String outputDir) throws IOException {
    ...
    try {
      ...
      EncodingAwareCompilerParsingThread errorParsingThread = errorParser == null
                                                 ? null
      ...
      EncodingAwareCompilerParsingThread outputParsingThread = outputParser == null
                                                  ? null
  ...
  private void registerParsingException(final EncodingAwareCompilerParsingThread outputParsingThread) {
