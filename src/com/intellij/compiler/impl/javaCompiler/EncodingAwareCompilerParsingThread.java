...
// todo Update CompilerParsingThread in IntelliJ to allow encoding to be configured.
public class EncodingAwareCompilerParsingThread implements Runnable, OutputParser.Callback {
  ...
  public EncodingAwareCompilerParsingThread(Process process, OutputParser outputParser, final boolean readErrorStream,
                                            boolean trimLines, CompileContext context, Charset encoding) {
    myProcess = process;
    ...
    myCompilerOutStreamReader = stream == null ? null : new BufferedReader(new InputStreamReader(stream, encoding), 16384);
