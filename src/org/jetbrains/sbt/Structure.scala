...
//
//def parseStructure(node: Node): Structure = {
...
//}
//
//def parseProject(node: Node): Project = {
...
//}
//
//def parseScala(node: Node): Scala = {
...
//}
//
//def parseConfiguration(node: Node): Configuration = {
//  val id = (node \ "@id").text
...
//}
//
//def parseModuleIdentifier(node: Node): ModuleIdentifier = {
...
//}
//
//def parseRepository(node: Node): Repository = {
