...
import com.intellij.execution.{LocatableConfigurationType, RunManager, RunnerAndConfigurationSettings, Location}
 ...
 * @since 10/16/12
 */
class WorksheetConfigurationType  extends LocatableConfigurationType {
