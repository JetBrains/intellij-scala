...
import org.jetbrains.plugins.scala.configuration.ModuleExt
import org.jetbrains.plugins.scala.configuration.notification.SetupScalaSdkNotificationProvider._
import org.jetbrains.plugins.scala.configuration.template.ScalaSupportProvider
