...
public final class ScalaConsoleViewImpl extends JPanel implements ConsoleView, ObservableConsoleView, DataProvider, OccurenceNavigator {
  ...
  private static final Key<ScalaConsoleViewImpl> CONSOLE_VIEW_IN_EDITOR_VIEW = Key.create("CONSOLE_VIEW_IN_EDITOR_VIEW");
  static {
  ...
  private static final DataAccessor<ScalaConsoleViewImpl> CONSOLE = new DataAccessor<ScalaConsoleViewImpl>() {
    public ScalaConsoleViewImpl getImpl(final DataContext dataContext) throws NoDataException {
      return DataAccessors.EDITOR.getNotNull(dataContext).getUserData(CONSOLE_VIEW_IN_EDITOR_VIEW);
    }
  };

  private static final Condition<ScalaConsoleViewImpl> CONSOLE_IS_RUNNING = new Condition<ScalaConsoleViewImpl>() {
    public boolean value(final ScalaConsoleViewImpl consoleView) {
  ...
  private abstract static class ConsoleAction extends AnAction {
    public void actionPerformed(final AnActionEvent e) {
      ...
      final ScalaConsoleViewImpl console = RUNNINT_CONSOLE.from(context);
      execute(console, context);
    }

    protected abstract void execute(ScalaConsoleViewImpl console, final DataContext context);

    public void update(final AnActionEvent e) {
      final ScalaConsoleViewImpl console = RUNNINT_CONSOLE.from(e.getDataContext());
