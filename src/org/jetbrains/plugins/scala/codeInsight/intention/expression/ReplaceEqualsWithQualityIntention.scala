...
object ReplaceEqualsWithQualityIntention {
  def familyName = "Replace 'equals' with '=='"
}

class ReplaceEqualsWithQualityIntention extends PsiElementBaseIntentionAction {
  def getFamilyName = ReplaceEqualsWithQualityIntention.familyName
  ...
  def isAvailable(project: Project, editor: Editor, element: PsiElement): Boolean = {
    ...
    if (infixExpr != null) {
      if (infixExpr.operation.nameId.getText != "equals") return false
      ...
      if (methodCallExpr.getInvokedExpr.asInstanceOf[ScReferenceExpression].nameId.getText != "equals") return false
  ...
  override def invoke(project: Project, editor: Editor, element: PsiElement) {
    ...
    if (infixExpr != null) {
      ...
      expr.append(infixExpr.getBaseExpr.getText).append(" == ").append(infixExpr.getArgExpr.getText)
      ...
      expr.append(methodCallExpr.asInstanceOf[ScMethodCall].getInvokedExpr.asInstanceOf[ScReferenceExpression].
              qualifier.get.getText).append(".==").append(methodCallExpr.args.getText)
