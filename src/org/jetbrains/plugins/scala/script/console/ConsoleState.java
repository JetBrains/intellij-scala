...
public abstract class ConsoleState {
  public static final ConsoleState NOT_STARTED = new ConsoleState(){
    public ConsoleState attachTo(final ScalaConsoleViewImpl console, final ProcessHandler processHandler) {
  ...
  public abstract ConsoleState attachTo(ScalaConsoleViewImpl console, ProcessHandler processHandler);

  private static class RunningState extends ConsoleState {
    private final ScalaConsoleViewImpl myConsole;
    ...
    public RunningState(final ScalaConsoleViewImpl console, final ProcessHandler processHandler) {
      myConsole = console;
