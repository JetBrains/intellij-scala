...
public class ScalaChangeContextUtil {
  private static final Logger LOG = Logger.getInstance("#org.jetbrains.plugins.scala.lang.refactoring.move.ScalaChangeContextUtil");
  ...
  private ScalaChangeContextUtil() {}
