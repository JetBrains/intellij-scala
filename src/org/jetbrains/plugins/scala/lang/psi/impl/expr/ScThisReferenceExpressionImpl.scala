...
class ScThisReferenceExpressionImpl(node: ASTNode) extends ScalaPsiElementImpl(node) with ScThisReferenceExpression {
  override def toString: String = "ThisReferenceExpression"
}