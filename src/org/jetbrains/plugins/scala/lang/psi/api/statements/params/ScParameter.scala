...
import toplevel.{ScModifierListOwner, ScNamedElement, ScTyped}
import types.ScType
/**
...
trait ScParameter extends ScNamedElement with ScTyped with ScModifierListOwner with PsiParameter with ScAnnotationsHolder {
