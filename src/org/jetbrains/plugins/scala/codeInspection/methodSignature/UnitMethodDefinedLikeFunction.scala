...
<p>A better way to express such methods is to leave off the result type and the equals sign,
...
<pre><code>
  ...
  <strong style="color:#000080">def</strong> close(): Unit = { file.delete() }

  <span style="color:#808080">// concise form, side-effect is clearly stated</span>
