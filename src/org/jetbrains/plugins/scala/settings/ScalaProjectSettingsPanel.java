...
public class ScalaProjectSettingsPanel {
    ...
    public void apply() {
        ...
        scalaProjectSettings.setShowTypeTooltipOnMouseHover(showTypeInfoOnCheckBox.isSelected());
        scalaProjectSettings.setShowTypeTooltipDelay((Integer) delaySpinner.getValue());
    ...
    public boolean isModified() {
        ...
        if (scalaProjectSettings.isShowTypeTooltipOnMouseHover() !=
            showTypeInfoOnCheckBox.isSelected()) return true;

        if (!scalaProjectSettings.getShowTypeTooltipDelay().equals(
            delaySpinner.getValue())) return true;
    ...
    private void setSettings() {
        ...
        setValue(delaySpinner, scalaProjectSettings.getShowTypeTooltipDelay());
        setValue(showTypeInfoOnCheckBox, scalaProjectSettings.isShowTypeTooltipOnMouseHover());
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.add(useScalaClassesPriorityCheckBox, new GridConstraints(18, 0, 1, 3, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel1.add(collectionHighlightingChooser, new GridConstraints(19, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel1.add(delaySpinner, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
