...
public class ScalaProjectSettings implements PersistentStateComponent<ScalaProjectSettings>, ExportableComponent {
    ...
    private boolean PERFORM_MACRO_EXPANSIONS = false;
    ...
    public boolean isGenerateToStringWithFieldNames() {
    ...
    public boolean isPerformMacroExpansions() {
        return PERFORM_MACRO_EXPANSIONS;
    }

    public void setPerformMacroExpansions(boolean PERFORM_MACRO_EXPANSIONS) {
        this.PERFORM_MACRO_EXPANSIONS = PERFORM_MACRO_EXPANSIONS;
    }
