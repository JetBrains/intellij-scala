...
class AnnotatorHolderMock(file: PsiFile) extends ScalaAnnotationHolder {
  ...
  override def createWeakWarningAnnotation(p1: TextRange, p2: String): Annotation =
    createAnnotation(HighlightSeverity.WEAK_WARNING, p1, p2)

  override def createWeakWarningAnnotation(p1: ASTNode, p2: String): Annotation =
    createAnnotation(HighlightSeverity.WEAK_WARNING, p1.getTextRange, p2)

  override def createWeakWarningAnnotation(p1: PsiElement, p2: String): Annotation =
    createAnnotation(HighlightSeverity.WEAK_WARNING, p1.getTextRange, p2)
