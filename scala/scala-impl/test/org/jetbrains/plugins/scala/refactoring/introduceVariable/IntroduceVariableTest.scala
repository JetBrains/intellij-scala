...
import org.jetbrains.plugins.scala.base.libraryLoaders.{JDK18Loader, ScalaSDKLoader}
...
class IntroduceVariableTest extends AbstractIntroduceVariableTestBase(TestUtils.getTestDataPath + IntroduceVariableTest.DATA_PATH)
  ...
  override protected def librariesLoaders = Seq(JDK18Loader(), ScalaSDKLoader())
}
