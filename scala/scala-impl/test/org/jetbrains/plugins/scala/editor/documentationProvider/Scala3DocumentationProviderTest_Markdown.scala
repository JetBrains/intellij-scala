  ...
  def testAllFeaturesCombined(): Unit = {
    ...
    doGenerateRenderedDocBodyTest(
      ...
      s"""
         ...
         |<span style="color:#000080">val</span> <span style="color:#000000">doubled</span> = numbers.map(_ * <span style="color:#0000ff">2</span>)</code></pre><h2>Parameters</h2></div><table class='sections'><tr><td valign='top' class='section'><p>Params:</td><td valign='top'><code>input</code> &ndash; <span><span></span><span></span>The input string to process</span><p><code>count</code> &ndash; <span><span></span><span></span>The number of times to process<h2>Return Value</h2></span></td><tr><td valign='top' class='section'><p>Returns:</td><td valign='top'><span><span></span>An <a href="psi_element://scala.Option"><code>scala.Option</code></a> containing the result<h2>Exceptions</h2></span></td><tr><td valign='top' class='section'><p>Throws:</td><td valign='top'><a href="psi_element://java.lang.IllegalArgumentException"><code>java.lang.IllegalArgumentException</code></a> &ndash; <span><span></span><span></span>if input is empty</span><p><a href="psi_element://java.lang.NullPointerException"><code>java.lang.NullPointerException</code></a> &ndash; <span><span></span><span></span>if input is null</span></td></table>
         |""".stripMargin,
