...
abstract class ScalaTodoItemsTestCaseBase extends ScalaLightCodeInsightFixtureTestAdapter with Markers {
  ...
  protected def doTodoTest(textWithMarkers: String): Unit = {
