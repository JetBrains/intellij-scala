...
class ScalaDocumentationProviderTest_SyntheticScalaLibraryElements
  ...
  def testSyntheticClass_Any(): Unit = {
    ...
    doGenerateDocAtCaretTest(
      s"""<html><head>$CssStyleSection<base href="jar:file:///$ivyHome/cache/org.scala-lang/scala-library/srcs/scala-library-2.13.14-sources.jar!/scala/Any.scala"></head><body><div class='definition'><pre><icon src="AllIcons.Nodes.Package"/> <a href="psi_element://scala"><code>scala</code></a>
         |
  ...
  def testSyntheticClass_Singleton(): Unit = {
    ...
    doGenerateDocAtCaretTest(
      s"""<html><head>$CssStyleSection<base href="jar:file:///$ivyHome/cache/org.scala-lang/scala-library/srcs/scala-library-2.13.14-sources.jar!/scala/Singleton.scala"></head><body><div class='definition'><pre><icon src="AllIcons.Nodes.Package"/> <a href="psi_element://scala"><code>scala</code></a>
         |
  ...
  def testSyntheticMethod_IsInstanceOf_InAny(): Unit = {
    ...
    doGenerateDocAtCaretTest(
      s"""<html><head>$CssStyleSection<base href="jar:file:///$ivyHome/cache/org.scala-lang/scala-library/srcs/scala-library-2.13.14-sources.jar!/scala/Any.scala"></head><body><div class='definition'><pre><a href="psi_element://scala.Any"><code>scala.Any</code></a>
         |
