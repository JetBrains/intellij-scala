...
class ScalaDocumentationProviderTest_SyntheticScalaLibraryElements
  ...
  def testSyntheticClass_Singleton(): Unit = {
    ...
    doGenerateDocAtCaretTest(
      s"""<html><head>$CssStyleSection<base href="jar:file:///${DependencyManagerBase.ivyHome}/cache/org.scala-lang/scala-library/srcs/scala-library-2.13.14-sources.jar!/scala/Singleton.scala"></head><body><div class='definition'><pre><icon src="AllIcons.Nodes.Package"/> <a href="psi_element://scala"><code>scala</code></a>
         ...
         |<span style="color:#000080;font-weight:bold;">extends</span> <span style=""><a href="psi_element://scala.Any"><code>Any</code></a></span></pre></div><div class='content'><tt>Singleton</tt> is used by the compiler as a supertype for singleton types. This includes literal types, as they are also singleton types.${CODE_BLOCK_PREFIX}<span style="">scala&gt;&#32;</span><span style="color:#000080;font-weight:bold;">object&#32;</span><span style="">A&#32;{&#32;</span><span style="color:#000080;font-weight:bold;">val&#32;</span><span style="">x&#32;=&#32;</span><span style="color:#0000ff;">42&#32;</span><span style="">}<br></span><span style="">defined&#32;</span><span style="color:#000080;font-weight:bold;">object&#32;</span><span style="">A<br></span><span style=""><br></span><span style="">scala&gt;&#32;implicitly[A.</span><span style="color:#000080;font-weight:bold;">type&#32;</span><span style="">&lt;:&lt;&#32;Singleton]<br></span><span style="">res12:&#32;A.</span><span style="color:#000080;font-weight:bold;">type&#32;</span><span style="">&lt;:&lt;&#32;Singleton&#32;=&#32;generalized&#32;constraint<br></span><span style=""><br></span><span style="">scala&gt;&#32;implicitly[A.x.</span><span style="color:#000080;font-weight:bold;">type&#32;</span><span style="">&lt;:&lt;&#32;Singleton]<br></span><span style="">res13:&#32;A.x.</span><span style="color:#000080;font-weight:bold;">type&#32;</span><span style="">&lt;:&lt;&#32;Singleton&#32;=&#32;generalized&#32;constraint<br></span><span style=""><br></span><span style="">scala&gt;&#32;implicitly[</span><span style="color:#0000ff;">42&#32;</span><span style="">&lt;:&lt;&#32;Singleton]<br></span><span style="">res14:&#32;</span><span style="color:#0000ff;">42&#32;</span><span style="">&lt;:&lt;&#32;Singleton&#32;=&#32;generalized&#32;constraint<br></span><span style=""><br></span><span style="">scala&gt;&#32;implicitly[Int&#32;&lt;:&lt;&#32;Singleton]<br></span><span style="">^<br></span><span style="">error:&#32;Cannot&#32;prove&#32;that&#32;Int&#32;&lt;:&lt;&#32;Singleton.</span>${CODE_BLOCK_SUFFIX}<p><tt>Singleton</tt> has a special meaning when it appears as an upper bound on a formal type parameter. Normally, type inference in Scala widens singleton types to the underlying non-singleton type. When a type parameter has an explicit upper bound of <tt>Singleton</tt>, the compiler infers a singleton type.</p>${CODE_BLOCK_PREFIX}<span style="">scala&gt;&#32;</span><span style="color:#000080;font-weight:bold;">def&#32;</span><span style="">check42[T](x:&#32;T)(</span><span style="color:#000080;font-weight:bold;">implicit&#32;</span><span style="">ev:&#32;T&#32;=:=&#32;</span><span style="color:#0000ff;">42</span><span style="">):&#32;T&#32;=&#32;x<br></span><span style="">check42:&#32;[T](x:&#32;T)(</span><span style="color:#000080;font-weight:bold;">implicit&#32;</span><span style="">ev:&#32;T&#32;=:=&#32;</span><span style="color:#0000ff;">42</span><span style="">)T<br></span><span style=""><br></span><span style="">scala&gt;&#32;</span><span style="color:#000080;font-weight:bold;">val&#32;</span><span style="">x1&#32;=&#32;check42(</span><span style="color:#0000ff;">42</span><span style="">)<br></span><span style="">^<br></span><span style="">error:&#32;Cannot&#32;prove&#32;that&#32;Int&#32;=:=&#32;</span><span style="color:#0000ff;">42.<br></span><span style="color:#0000ff;"><br></span><span style="">scala&gt;&#32;</span><span style="color:#000080;font-weight:bold;">def&#32;</span><span style="">singleCheck42[T&#32;&lt;:&#32;Singleton](x:&#32;T)(</span><span style="color:#000080;font-weight:bold;">implicit&#32;</span><span style="">ev:&#32;T&#32;=:=&#32;</span><span style="color:#0000ff;">42</span><span style="">):&#32;T&#32;=&#32;x<br></span><span style="">singleCheck42:&#32;[T&#32;&lt;:&#32;Singleton](x:&#32;T)(</span><span style="color:#000080;font-weight:bold;">implicit&#32;</span><span style="">ev:&#32;T&#32;=:=&#32;</span><span style="color:#0000ff;">42</span><span style="">)T<br></span><span style=""><br></span><span style="">scala&gt;&#32;</span><span style="color:#000080;font-weight:bold;">val&#32;</span><span style="">x2&#32;=&#32;singleCheck42(</span><span style="color:#0000ff;">42</span><span style="">)<br></span><span style="">x2:&#32;Int&#32;=&#32;</span><span style="color:#0000ff;">42</span>${CODE_BLOCK_SUFFIX}<p>See also <a href="https://docs.scala-lang.org/sips/42.type.html">SIP-23 about Literal-based Singleton Types</a>.</p></div></body></html>""".stripMargin)
  }
  ...
  def testSyntheticMethod_IsInstanceOf_InAny(): Unit = {
    ...
    doGenerateDocAtCaretTest(
      s"""<html><head>$CssStyleSection<base href="jar:file:///${DependencyManagerBase.ivyHome}/cache/org.scala-lang/scala-library/srcs/scala-library-2.13.14-sources.jar!/scala/Any.scala"></head><body><div class='definition'><pre><a href="psi_element://scala.Any"><code>scala.Any</code></a>
         |
