...
class ImplicitConvertScalaToJavaCollectionIntentionTest extends ScalaIntentionTestBase {

  def familyName: String = ImplicitConvertScalaToJavaCollectionIntention.getFamilyName
