...
class ScalaLanguageSubstitutorTest {
  ...
  @Test
  def looksLikeScala3LibJar_DevVersions(): Unit = {
  ...
  @Test
  def looksLikeScala3LibJar_DevVersions_WithBuildData(): Unit = {
  ...
  @Test
  def doesNotLookLikeScala3LibJar_ContainsDotInsteadOfHyphenAfterPatchVersionPart(): Unit = {
  ...
  @Test
  def doesNotLookLikeScala3LibJar_DoesntContainSourcesJarSuffix(): Unit = {
  ...
  @Test
  def doesNotLookLikeScala3LibJar_TestFullPath(): Unit = {
