 ...
 */
@TestOnly
public class CodeInsightTestFixtureImpl extends BaseFixture implements CodeInsightTestFixture, JavaCodeInsightTestFixture {
  ...
  @Override
  public void testCompletion(String[] filesBefore, @NotNull @TestDataFile String fileAfter) {
    testCompletionTyping(filesBefore, "", fileAfter);
  }

  @Override
  public void testCompletionTyping(String[] filesBefore, @NotNull String toType, @NotNull String fileAfter) {
    assertInitialized();
  ...
  public void testCompletion(@NotNull String fileBefore,
                             ...
                             @TestDataFile String... additionalFiles) {
  ...
  @Override
  public void moveFile(@NotNull String filePath, @NotNull String to, @TestDataFile String... additionalFiles) {
    assertInitialized();
    Project project = getProject();
