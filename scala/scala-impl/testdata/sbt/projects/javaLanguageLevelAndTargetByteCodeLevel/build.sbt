...
val module_18_x_x_preview = project.settings(javacOptions := Seq("-source", "18", "--enable-preview"))
...
val module_x_x_18_preview = project.settings(javacOptions := Seq("--release", "18", "--enable-preview"))