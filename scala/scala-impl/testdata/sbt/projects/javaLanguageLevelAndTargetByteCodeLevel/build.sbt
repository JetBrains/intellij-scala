...
val module_15_x_x_preview = project.settings(javacOptions := Seq("-source", "15", "--enable-preview"))
val module_16_x_x_preview = project.settings(javacOptions := Seq("-source", "16", "--enable-preview"))
...
val module_x_x_15_preview = project.settings(javacOptions := Seq("--release", "15", "--enable-preview"))
val module_x_x_16_preview = project.settings(javacOptions := Seq("--release", "16", "--enable-preview"))