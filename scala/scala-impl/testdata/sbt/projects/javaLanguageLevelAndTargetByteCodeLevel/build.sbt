...
val module_19_x_x_preview = project.settings(javacOptions := Seq("-source", "19", "--enable-preview"))
...
val module_x_x_19_preview = project.settings(javacOptions := Seq("--release", "19", "--enable-preview"))
