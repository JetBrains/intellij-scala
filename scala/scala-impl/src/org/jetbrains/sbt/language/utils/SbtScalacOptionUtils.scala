...
object SbtScalacOptionUtils {
  ...
  private def scalacOptionsForUnitTests: Seq[SbtScalacOptionInfo] = {
    ...
    val versions = Set(Scala_2_9, Scala_2_10, Scala_2_11, Scala_2_12, Scala_2_13, Scala_3_0)
    ...
    Seq(
      ...
      SbtScalacOptionInfo(
        ...
        scalaVersions = versions - Scala_2_9
      ),
      SbtScalacOptionInfo(
      ...
      SbtScalacOptionInfo(
        flag = "-Xprint",
        description = "Print out program after",
        scalaVersions = versions - Scala_2_13
      )
    )
  }
}
