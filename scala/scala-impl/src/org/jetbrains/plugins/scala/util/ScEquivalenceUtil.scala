...
import org.jetbrains.plugins.scala.lang.psi.types.{ConstraintSystem, ConstraintsResult, ConformanceContext, ScType, ScTypeExt}
...
object ScEquivalenceUtil {
  ...
  private def areTypeAliasesEquivalent(ta1: ScTypeAlias, ta2: ScTypeAlias)(implicit context: ConformanceContext): Boolean = {
  ...
  def smartEquivalence(elem1: PsiElement, elem2: PsiElement)(implicit context: ConformanceContext): Boolean =
    (elem1, elem2) match {
