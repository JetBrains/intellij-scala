...
private class CacheWithoutModificationCount0[R](id: String, name: String, wrapper: ValueWrapper, cleanupScheduler: CleanupScheduler) {
  // Code generated by @CachedWithoutModificationCount macro annotation, method without parameters

  @volatile
  private[this] var reference: ValueWrapper.Reference[R] = null
