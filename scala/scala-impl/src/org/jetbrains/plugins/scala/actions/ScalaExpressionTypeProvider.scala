...
//NOTE: ScalaExpressionTypeProvider is commented in scala-plugin-common.xml so not effectively used
// do not remove it for some time beaing
...
//    val colorFinal = ColorUtil.toHtmlColor(DocumentationComponent.SECTION_COLOR)
//    val titleFinal = StringUtil.escapeXmlEntities(title)
//    val titleCell = s"<td align='left' valign='top' style='color:$colorFinal'>$titleFinal:</td>"
