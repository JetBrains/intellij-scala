...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadButtonText$$$(enableIndexingCB, this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "scala.compiler.indices.settings.enable.cb"));
        ...
        this.$$$loadButtonText$$$(deleteButton, this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "scala.compiler.indices.settings.invalidate.button"));
        ...
        titledSeparator1.setText(this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "sbt.compilation.listener"));
        ...
        this.$$$loadButtonText$$$(automaticConfigButton, this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "scala.compiler.indices.sbt.automatic"));
        ...
        this.$$$loadButtonText$$$(manualConfigButton, this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "scala.compiler.indices.sbt.manual"));
        ...
        this.$$$loadLabelText$$$(label1, this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "port.number"));
        ...
        this.$$$loadLabelText$$$(jBLabel2, this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "add.line.to.build.sbt"));
        ...
        this.$$$loadButtonText$$$(implicitDefinitionsCB, this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "implicit.definitions"));
        ...
        this.$$$loadButtonText$$$(applyMethodCB, this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "apply.unapply.methods"));
        ...
        this.$$$loadButtonText$$$(samTypesCB, this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "sam.types"));
        ...
        this.$$$loadButtonText$$$(forCompMethodCB, this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "for.comprehension.methods"));
        ...
        this.$$$loadLabelText$$$(jBLabel3, this.$$$getMessageFromBundle$$$("messages/ScalaBundle", "use.indices.to.search"));
