...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadButtonText$$$(enableIndexingCB, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.compiler.indices.settings.enable.cb"));
        ...
        this.$$$loadButtonText$$$(deleteButton, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.compiler.indices.settings.invalidate.button"));
        ...
        titledSeparator1.setText(ResourceBundle.getBundle("messages/ScalaBundle").getString("sbt.compilation.listener"));
        ...
        this.$$$loadButtonText$$$(automaticConfigButton, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.compiler.indices.sbt.automatic"));
        ...
        this.$$$loadButtonText$$$(manualConfigButton, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.compiler.indices.sbt.manual"));
        ...
        this.$$$loadLabelText$$$(label1, ResourceBundle.getBundle("messages/ScalaBundle").getString("port.number"));
        ...
        pluginSettignsTextArea.setText(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.compiler.indices.sbt.plugin.text"));
        ...
        this.$$$loadLabelText$$$(jBLabel1, ResourceBundle.getBundle("messages/ScalaBundle").getString("add.line.to.plugins.sbt"));
        ...
        this.$$$loadLabelText$$$(jBLabel2, ResourceBundle.getBundle("messages/ScalaBundle").getString("add.line.to.build.sbt"));
        ...
        this.$$$loadButtonText$$$(implicitDefinitionsCB, ResourceBundle.getBundle("messages/ScalaBundle").getString("implicit.definitions"));
        ...
        this.$$$loadButtonText$$$(applyMethodCB, ResourceBundle.getBundle("messages/ScalaBundle").getString("apply.unapply.methods"));
        ...
        this.$$$loadButtonText$$$(samTypesCB, ResourceBundle.getBundle("messages/ScalaBundle").getString("sam.types"));
        ...
        this.$$$loadButtonText$$$(forCompMethodCB, ResourceBundle.getBundle("messages/ScalaBundle").getString("for.comprehension.methods"));
        ...
        this.$$$loadLabelText$$$(jBLabel3, ResourceBundle.getBundle("messages/ScalaBundle").getString("use.indices.to.search"));
