...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadButtonText$$$(enableIndexingCB, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "scala.compiler.indices.settings.enable.cb"));
        ...
        this.$$$loadButtonText$$$(deleteButton, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "scala.compiler.indices.settings.invalidate.button"));
        ...
        titledSeparator1.setText(this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "sbt.compilation.listener"));
        ...
        this.$$$loadButtonText$$$(automaticConfigButton, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "scala.compiler.indices.sbt.automatic"));
        ...
        this.$$$loadButtonText$$$(manualConfigButton, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "scala.compiler.indices.sbt.manual"));
        ...
        this.$$$loadLabelText$$$(label1, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "port.number"));
        ...
        pluginSettignsTextArea.setText(this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "scala.compiler.indices.sbt.plugin.text"));
        ...
        this.$$$loadLabelText$$$(jBLabel1, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "add.line.to.plugins.sbt"));
        ...
        this.$$$loadLabelText$$$(jBLabel2, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "add.line.to.build.sbt"));
        ...
        this.$$$loadButtonText$$$(implicitDefinitionsCB, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "implicit.definitions"));
        ...
        this.$$$loadButtonText$$$(applyMethodCB, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "apply.unapply.methods"));
        ...
        this.$$$loadButtonText$$$(samTypesCB, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "sam.types"));
        ...
        this.$$$loadButtonText$$$(forCompMethodCB, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "for.comprehension.methods"));
        ...
        this.$$$loadLabelText$$$(jBLabel3, this.$$$getMessageFromBundle$$$("org/jetbrains/plugins/scala/ScalaBundle", "use.indices.to.search"));
