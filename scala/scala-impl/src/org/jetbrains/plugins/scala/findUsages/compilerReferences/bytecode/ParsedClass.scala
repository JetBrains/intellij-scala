 ...
 */
private[compilerReferences] final case class ClassInfo(
  isAnonymous:  Boolean,
  fqn:          String,
 ...
 */
private[compilerReferences] sealed trait MemberReference {
...
private[compilerReferences] final case class FieldReference(
  override val owner: String,
  override val name:  String,
  override val line:  Int
) extends MemberReference

private[compilerReferences] final case class MethodReference(
  override val owner: String,
  override val name:  String,
  override val line:  Int,
  args:               Int
...
private[compilerReferences] final case class FunExprInheritor(
  interface: String,
  line:      Int
)

private[compilerReferences] sealed trait ParsedClass {
  def classInfo: ClassInfo
  def refs: Seq[MemberReference]
  def funExprs: Seq[FunExprInheritor]
}

private[compilerReferences] final case class RegularClass(
  override val classInfo: ClassInfo,
  override val refs:      Seq[MemberReference],
  override val funExprs:  Seq[FunExprInheritor],
) extends ParsedClass

private[compilerReferences] final case class FunExprClass(
  override val classInfo: ClassInfo,
  override val refs:      Seq[MemberReference],
  line:                   Int
) extends ParsedClass {
