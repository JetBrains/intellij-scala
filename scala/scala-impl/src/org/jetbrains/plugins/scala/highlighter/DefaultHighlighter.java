...
public class DefaultHighlighter {
  ...
  static final String SCALA_CLI_DIRECTIVE_PREFIX_ID = "Scala CLI directive prefix";
  static final String SCALA_CLI_DIRECTIVE_COMMAND_ID = "Scala CLI directive command";
  static final String SCALA_CLI_DIRECTIVE_KEY_ID = "Scala CLI directive key";
  static final String SCALA_CLI_DIRECTIVE_VALUE_ID = "Scala CLI directive value";
  ...
  // Scala CLI directives
  public static final TextAttributesKey SCALA_CLI_DIRECTIVE_PREFIX = createKey(SCALA_CLI_DIRECTIVE_PREFIX_ID, DefaultLanguageHighlighterColors.KEYWORD);
  public static final TextAttributesKey SCALA_CLI_DIRECTIVE_COMMAND = createKey(SCALA_CLI_DIRECTIVE_COMMAND_ID, DefaultLanguageHighlighterColors.KEYWORD);
  public static final TextAttributesKey SCALA_CLI_DIRECTIVE_KEY = createKey(SCALA_CLI_DIRECTIVE_KEY_ID, DefaultLanguageHighlighterColors.KEYWORD);
  public static final TextAttributesKey SCALA_CLI_DIRECTIVE_VALUE = createKey(SCALA_CLI_DIRECTIVE_VALUE_ID, DefaultLanguageHighlighterColors.KEYWORD);
