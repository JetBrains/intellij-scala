...
private class ScalaModuleSettings private(
  ...
  def XKindProjectorUnderscoresOptionEnabled: Boolean =
    scalaLanguageLevel >= Scala_3_5 &&
      additionalCompilerOptions.contains("-Xkind-projector:underscores")
