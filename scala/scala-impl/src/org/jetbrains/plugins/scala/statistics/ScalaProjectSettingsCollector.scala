...
private object ScalaProjectSettingsCollector {
  private val Group = new EventLogGroup("scala.project.settings", 1) // TODO: SCL-24479
  ...
  private val SbtShellBuildEvent = Group.registerEvent("sbt.shell.build") // TODO: SCL-24479
  private val SbtIdeaBuildEvent = Group.registerEvent("sbt.idea.build") // TODO: SCL-24479

  private val CompilerIncTypeUsedSbtEvent = Group.registerEvent("compiler.inc.type.used.sbt") // TODO: SCL-24479
  private val CompilerIncTypeUsedIdeaEvent = Group.registerEvent("compiler.inc.type.used.idea") // TODO: SCL-24479
  private val CompilerCompileServerUsedEvent = Group.registerEvent("compiler.compile.server.used") // TODO: SCL-24479
  private val ProjectViewHighlightingEvent = Group.registerEvent("project.view.highlighting") // TODO: SCL-24479
}
