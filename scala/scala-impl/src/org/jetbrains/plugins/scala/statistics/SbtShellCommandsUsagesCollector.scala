...
object SbtShellCommandsUsagesCollector {
   ...
   */
  private val Group = new EventLogGroup("scala.sbt", 1) // TODO: SCL-24479

  private val ShellCommandEvent = Group.registerEvent("shell.execute.command") // TODO: SCL-24479
  private val ShellTestCommandEvent = Group.registerEvent("shell.test.command") // TODO: SCL-24479
  private val ShellTestRunCommandEvent = Group.registerEvent("shell.test.run.command") // TODO: SCL-24479
