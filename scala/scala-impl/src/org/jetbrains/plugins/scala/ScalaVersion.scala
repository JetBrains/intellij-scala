...
object LatestScalaVersions {
  ...
  val Scala_2_13 = new ScalaVersion(ScalaLanguageLevel.Scala_2_13, "18-bin-ae6ae4d")
  ...
  val Scala_3_7 = new ScalaVersion(ScalaLanguageLevel.Scala_3_7, "3")
  ...
  // Scala Next RC
  val Scala_3_Next_RC: ScalaVersion = new ScalaVersion(ScalaLanguageLevel.Scala_3_7, "4-RC3")
