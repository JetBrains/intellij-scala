...
object ScNewTemplateDefinitionAnnotator extends ElementAnnotator[ScNewTemplateDefinition] {
  override def annotate(element: ScNewTemplateDefinition, holder: AnnotationHolder, typeAware: Boolean): Unit = {
    annotateAbstractInstantiation(element, holder)
  }

  // TODO package private
  def annotateAbstractInstantiation(element: ScNewTemplateDefinition, holder: AnnotationHolder): Unit = {
