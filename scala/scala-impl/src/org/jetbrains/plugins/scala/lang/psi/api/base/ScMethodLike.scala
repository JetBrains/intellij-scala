...
import org.jetbrains.plugins.scala.lang.psi.api.toplevel.typedef.{ScMember, ScMemberBase, ScTypeDefinition}
 ...
 */
trait ScMethodLikeBase extends ScMemberBase with PsiMethod with PsiTypeParametersOwnerAdapter with ScTypeParametersOwnerBase { this: ScMethodLike =>
