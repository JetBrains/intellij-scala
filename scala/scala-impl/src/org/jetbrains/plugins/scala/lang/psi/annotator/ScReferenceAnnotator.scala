...
import org.jetbrains.plugins.scala.lang.psi.api.{Annotatable, ScalaFile, ScalaPsiElement}
...
trait ScReferenceAnnotator extends Annotatable { self: ScReference =>
  abstract override def annotate(holder: AnnotationHolder, typeAware: Boolean): Unit = {
    ...
    qualifierPart(holder, typeAware)
  }

  // TODO encapsulate
  def annotateReference(holder: AnnotationHolder): Unit = {
    ScReferenceAnnotator.annotateReference(this, holder)
  }

  // TODO encapsulate
  def qualifierPart(holder: AnnotationHolder, typeAware: Boolean): Unit = {
    this.qualifier match {
      case None => ScReferenceAnnotator.checkNotQualifiedReferenceElement(this, holder, typeAware)
      case Some(_) => ScReferenceAnnotator.checkQualifiedReferenceElement(this, holder, typeAware)
    }
  }
}

// TODO encapsulate
// TODO convert object methods to class instance methods
object ScReferenceAnnotator {
