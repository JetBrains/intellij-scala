...
import org.jetbrains.plugins.scala.lang.psi.annotator.ScForBindingAnnotator
...
class ScForBindingImpl(node: ASTNode) extends ScalaPsiElementImpl(node) with ScForBinding with ScEnumeratorImpl with ScForBindingAnnotator {
