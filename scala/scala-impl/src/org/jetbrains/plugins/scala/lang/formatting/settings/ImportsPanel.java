...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadButtonText$$$(addImportStatementInCheckBox, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.add.import.statement.in.closest.block"));
        ...
        this.$$$loadButtonText$$$(addFullQualifiedImportsCheckBox, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.add.fully.qualified.imports"));
        ...
        this.$$$loadButtonText$$$(sortImportsCheckBox, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.sort.imports.for.optimize.imports"));
        ...
        this.$$$loadButtonText$$$(importTheShortestPathCheckBox, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.use.the.shortest.path.when.trying.to.import.reference.with.already.imported.name"));
        ...
        this.$$$loadButtonText$$$(collectImportsWithTheCheckBox, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.collect.imports.with.the.same.prefix.into.one.import"));
        ...
        this.$$$loadLabelText$$$(label1, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.class.count.to.use.import.with"));
        ...
        panel3.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.classes.to.use.only.with.prefix")));
        ...
        panel5.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.import.layout")));
        ...
        panel6.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.imports.always.marked.as.used")));
        ...
        this.$$$loadButtonText$$$(doNotChangePathCheckBox, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.do.not.change.path.during.optimize.imports.for.local.imports"));
        ...
        this.$$$loadButtonText$$$(sortScalastyleRb, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.scalastyle.consistent"));
        ...
        this.$$$loadButtonText$$$(sortLexicographicallyRb, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("imports.panel.lexicographically"));
