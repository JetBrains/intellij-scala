...
object ScalaAnonymousClassesNodeProvider {
   ...
   *       }
   *     }}}
   *     See [[org.jetbrains.plugins.scala.lang.structureView.element.TypeDefinition.childrenOf]]
   *     and [[org.jetbrains.plugins.scala.lang.structureView.element.Block.childrenOf]]
   *
   *  1. var/var fields definition can have nested children only when it's body is a block expression<br>
   *     See [[org.jetbrains.plugins.scala.lang.structureView.element.ValOrVar.children]]
   */
    ...
    elementToStartFrom.depthFirst { element =>
      val processChildren = element match {
        ...
        case v: ScValueOrVariableDefinition =>
          ...
          val collectAnonimousClassesInside = !(isField && hasBlockBody)
          ...
          if (collectAnonimousClassesInside) {
