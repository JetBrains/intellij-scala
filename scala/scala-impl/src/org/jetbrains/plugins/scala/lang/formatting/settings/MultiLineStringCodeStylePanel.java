...
public class MultiLineStringCodeStylePanel extends CodeStyleAbstractPanel {
    ...
    supportLevelChooser.addActionListener(e -> {
      if (supportLevelChooser.getSelectedIndex() != ScalaCodeStyleSettings.MULTILINE_STRING_ALL) {
        ...
        supportLevelChooser.addActionListener(e -> {
            if (supportLevelChooser.getSelectedIndex() < ScalaCodeStyleSettings.MULTILINE_STRING_INSERT_MARGIN_CHAR) {
                processMarginCheckBox.setSelected(false);
                processMarginCheckBox.setEnabled(false);
            } else {
                processMarginCheckBox.setEnabled(true);
    ...
    public void apply(CodeStyleSettings settings) {
        ...
        scalaSettings.MULTILINE_STRING_SUPPORT = supportLevelChooser.getSelectedIndex();
    ...
    public boolean isModified(CodeStyleSettings settings) {
        ...
        if (scalaSettings.MULTILINE_STRING_SUPPORT != supportLevelChooser.getSelectedIndex()) return true;
    ...
    private void setSettings(ScalaCodeStyleSettings scalaSettings) {
        supportLevelChooser.setSelectedIndex(scalaSettings.MULTILINE_STRING_SUPPORT);
