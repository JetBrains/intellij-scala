...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadButtonText$$$(openingQuotesOnNewCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("multi.line.string.panel.opening.quotes.on.new.line"));
        ...
        this.$$$loadButtonText$$$(closingQuotesOnNewLine, ResourceBundle.getBundle("messages/ScalaBundle").getString("multi.line.string.panel.place.closing.quotes.on.new.line.on.enter.press"));
        ...
        this.$$$loadButtonText$$$(insertMarginChar, ResourceBundle.getBundle("messages/ScalaBundle").getString("multi.line.string.panel.insert.margin.char.on.enter"));
        ...
        this.$$$loadLabelText$$$(label1, ResourceBundle.getBundle("messages/ScalaBundle").getString("multi.line.string.panel.margin.char.value"));
        ...
        this.$$$loadLabelText$$$(label2, ResourceBundle.getBundle("messages/ScalaBundle").getString("multi.line.string.panel.margin.char.indent"));
        ...
        this.$$$loadButtonText$$$(processMarginCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("multi.line.string.panel.process.margin.on.copy.paste"));
        ...
        this.$$$loadButtonText$$$(alignDanglingClosingQuotes, ResourceBundle.getBundle("messages/ScalaBundle").getString("multi.line.string.panel.align.dangling.closing.quotes"));
