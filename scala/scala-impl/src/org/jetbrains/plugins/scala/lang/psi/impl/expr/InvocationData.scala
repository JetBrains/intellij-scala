...
object InvocationData {
  ...
  object Success {
    def fromApplyUpdate(inferredType: ScType, applyOrUpdateElem: Option[ScalaResolveResult]): Success = {
      ...
      Success(inferredType, Seq.empty, Seq.empty, importsUsed, implicitFunction, applyOrUpdateElem)
    }
  }
