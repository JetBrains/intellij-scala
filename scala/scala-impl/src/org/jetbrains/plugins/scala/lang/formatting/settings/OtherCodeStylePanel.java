...
public final class OtherCodeStylePanel extends ScalaCodeStylePanelBase {
  ...
  private void $$$setupUI$$$() {
    ...
    this.$$$loadButtonText$$$(enforceFunctionalSyntaxForCheckBox, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("other.panel.enforce.functional.syntax.for.methods.with.unit.return.type"));
    ...
    this.$$$loadButtonText$$$(replaceWithUnicodeSymbolCheckBox, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("other.panel.replace.with.unicode.symbol"));
    ...
    this.$$$loadButtonText$$$(replaceWithUnicodeSymbolCheckBox1, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("other.panel.replace.with.unicode.symbol1"));
    ...
    this.$$$loadButtonText$$$(replaceInForGeneratorCheckBox, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("other.panel.replace.in.for.generator.with.unicode.symbol"));
    ...
    this.$$$loadButtonText$$$(replaceLambdaWithGreekLetter, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("other.panel.kind.projector.replace.lambda.with.unicode.symbol"));
    ...
    this.$$$loadButtonText$$$(alternateIndentationForParamsCheckBox, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("other.panel.alternate.indentation.for.constructor.args.and.parameter.declarations"));
    ...
    this.$$$loadLabelText$$$(spacesLabel, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("other.panel.spaces"));
    ...
    this.$$$loadButtonText$$$(reformatOnCompileCheckBox, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("other.panel.reformat.on.compile"));
    ...
    this.$$$loadLabelText$$$(label1, ResourceBundle.getBundle("org/jetbrains/plugins/scala/ScalaBundle").getString("other.panel.implicit.value.class.prefix.suffux"));
