...
object ExpectedTypesImpl {
  ...
  private val knownExpectedTypes =
    new UnloadableThreadLocal[ju.Map[ScExpression, KnownExpectedType]](new util.HashMap[ScExpression, KnownExpectedType]())

  def knownExpectedTypesFor(expr: ScExpression): Option[Array[ParameterType]] = {
