 ...
 */
trait ScTypeDefinitionBase extends ScTemplateDefinitionBase with ScMember.WithBaseIconProvider with NavigationItem with PsiClassAdapter with ScTypeParametersOwnerBase with ScDocCommentOwnerBase with ScCommentOwnerBase { this: ScTypeDefinition =>
