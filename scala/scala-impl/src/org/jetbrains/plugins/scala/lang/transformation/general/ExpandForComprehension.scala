...
class ExpandForComprehension extends AbstractTransformer {
  ...
  private def desugarRecursively(e: PsiElement)(implicit project: ProjectContext) {
  ...
  private def clean(e: PsiElement)(implicit project: ProjectContext) {
  ...
  private def removeRedundantCaseClausesIn(e: PsiElement)(implicit project: ProjectContext) = Some(e) collect {
  ...
  private def convertRedundantBlockArgument(e: PsiElement)(implicit project: ProjectContext) = Some(e) collect {
