...
final class ScalaStubRegistryExtension extends ScalaStubRegistryExtensionAdapter {
  override def register(registry: StubRegistry): Unit = {
    registerFileStubSerializer(registry, ScalaParserDefinition.FileNodeType)
    registerFileStubSerializer(registry, Scala3ParserDefinition.FileNodeType)
...
trait ScalaStubRegistryExtensionAdapter extends StubRegistryExtension {
  def registerFileStubSerializer[FileType <: ScStubFileElementType](
