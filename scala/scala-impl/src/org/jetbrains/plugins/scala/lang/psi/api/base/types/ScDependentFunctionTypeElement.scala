 ...
 */
trait ScDependentFunctionTypeElementBase extends ScTypeElementBase { this: ScDependentFunctionTypeElement =>
...
abstract class ScDependentFunctionTypeElementCompanion {
