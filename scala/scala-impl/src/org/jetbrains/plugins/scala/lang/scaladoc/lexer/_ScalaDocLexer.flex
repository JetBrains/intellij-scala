...
<COMMENT_DATA, COMMENT_DATA_START> \\"$"{MACRO_IDENTIFIER} { return DOC_COMMENT_DATA; }
...
<PARAM_DEFINE_TAG_DOC_SPACE> {WHITE_DOC_SPACE_NO_NL}+ {yybegin(PARAM_DOC_DEFINE_TAG_VALUE); return DOC_WHITESPACE;}
<PARAM_DOC_DEFINE_TAG_VALUE> {MACRO_IDENTIFIER} { yybegin(DOC_TAG_VALUE_SPACE); return DOC_TAG_VALUE_TOKEN; }
<PARAM_DEFINE_TAG_DOC_SPACE, PARAM_DOC_DEFINE_TAG_VALUE> [^] { yypushback(1); yybegin(COMMENT_DATA);  }
