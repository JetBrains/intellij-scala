...
import org.jetbrains.plugins.scala.editor.documentationProvider.{HtmlPsiUtils, NewLineSeparatorInDefinitionSection}
...
final private [documentationProvider] class ScalaDocAnnotationRenderer(typeRenderer: TypeRenderer)
  extends AnnotationsRenderer(
    typeRenderer,
    NewLineSeparatorInDefinitionSection,
    TextEscaper.Html
  ) {
