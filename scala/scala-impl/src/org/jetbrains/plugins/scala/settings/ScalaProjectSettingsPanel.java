...
public class ScalaProjectSettingsPanel {
    ...
    private void $$$setupUI$$$() {
        ...
        tabbedPane.addTab(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.tabs.editor"), panel1);
        ...
        this.$$$loadButtonText$$$(showImplicitConversionsInCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.highlight.implicit.conversions"));
        ...
        this.$$$loadButtonText$$$(showArgumentsToByNameParametersCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.highlight.arguments.to.by.name.parameters"));
        ...
        this.$$$loadButtonText$$$(includeBlockExpressionsExpressionsCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.include.block.expressions"));
        ...
        this.$$$loadButtonText$$$(includeLiteralsCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.include.literals"));
        ...
        titledSeparator1.setText(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.highlighting"));
        ...
        titledSeparator2.setText(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.autocomplete"));
        ...
        this.$$$loadButtonText$$$(myAotCompletion, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.ahead.of.time.completion"));
        ...
        this.$$$loadButtonText$$$(useScalaClassesPriorityCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.use.scala.classes.priority.over.java"));
        ...
        this.$$$loadButtonText$$$(enableConversionOnCopyCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.convert.java.code.to.scala.on.copy.paste"));
        ...
        this.$$$loadButtonText$$$(donTShowDialogCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.automatically.convert.to.scala.code.without.dialog"));
        ...
        titledSeparator3.setText(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.code.conversion"));
        ...
        this.$$$loadButtonText$$$(showTypeInfoOnCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.show.type.info.on.mouse.hover"));
        ...
        this.$$$loadButtonText$$$(customScalatestSyntaxHighlightingCheckbox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.custom.scalatest.keywords.highlighting"));
        ...
        this.$$$loadButtonText$$$(addOverrideToImplementCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.add.override.keyword.to.method.implementation"));
        ...
        this.$$$loadButtonText$$$(showNotFoundImplicitArgumentsCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.show.hints.if.no.implicit.arguments.found"));
        ...
        this.$$$loadLabelText$$$(label1, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.collection.type.highlighting.option"));
        ...
        tabbedPane.addTab(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.tabs.project.view"), panel4);
        myProjectViewHighlighting = new JCheckBox();
        this.$$$loadButtonText$$$(myProjectViewHighlighting, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.highlight.nodes.with.errors"));
        ...
        this.$$$loadButtonText$$$(myGroupPackageObjectWithPackage, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.group.package.object.with.package"));
        ...
        tabbedPane.addTab(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.tabs.performance"), panel5);
        ...
        this.$$$loadLabelText$$$(label2, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.implicit.parameters.search.depth"));
        ...
        this.$$$loadButtonText$$$(myResolveToAllClassesCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.resolve.to.all.classes.even.in.wrong.directories"));
        ...
        this.$$$loadButtonText$$$(treatDocCommentAsBlockComment, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.disable.parsing.of.documentation.comments"));
        ...
        this.$$$loadButtonText$$$(myDisableLanguageInjection, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.disable.language.injection.in.scala.files"));
        ...
        this.$$$loadButtonText$$$(myDontCacheCompound, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.dont.cache.compound.types"));
        ...
        this.$$$loadButtonText$$$(searchAllSymbolsIncludeCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.search.all.symbols"));
        ...
        this.$$$loadLabelText$$$(label3, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.scala.meta.settings.annot212"));
        label3.setToolTipText(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.scala.meta.settings.annot212.tooltip"));
        ...
        scalaMetaMode.setToolTipText(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.scala.meta.settings.modeOptions.tooltip"));
        ...
        this.$$$loadButtonText$$$(metaTrimBodies, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.scala.meta.settings.trimBodies.caption"));
        metaTrimBodies.setToolTipText(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.scala.meta.settings.trimBodies.tooltip"));
        ...
        ivy2IndexingModeCBB.setToolTipText(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.sbt.index.ivy2.mode.hint"));
        ...
        this.$$$loadLabelText$$$(label4, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.sbt.index.ivy2.mode"));
        label4.setToolTipText(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.sbt.index.ivy2.mode.hint"));
        ...
        tabbedPane.addTab(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.tabs.worksheet"), panel6);
        ...
        this.$$$loadButtonText$$$(runWorksheetInTheCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.run.worksheet.in.the.compiler.process"));
        ...
        this.$$$loadLabelText$$$(label5, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.output.cutoff.limit"));
        ...
        this.$$$loadButtonText$$$(useEclipseCompatibilityModeCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.use.eclipse.compatibility.mode"));
        ...
        this.$$$loadButtonText$$$(treatScalaScratchFilesCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.treat.scala.scratch.files.as.worksheet.files"));
        ...
        this.$$$loadLabelText$$$(label6, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.delay.before.auto.run"));
        ...
        this.$$$loadLabelText$$$(label7, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.treat.sc.files.as"));
        ...
        this.$$$loadButtonText$$$(collapseWorksheetFoldByCheckBox, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.collapse.long.output.by.default"));
        ...
        tabbedPane.addTab(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.tabs.base.packages"), panel7);
        ...
        tabbedPane.addTab(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.tabs.misc"), panel8);
        ...
        this.$$$loadLabelText$$$(label8, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.scalatest.default.super.class"));
        ...
        this.$$$loadLabelText$$$(label9, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.trailing.commas"));
        ...
        tabbedPane.addTab(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.tabs.updates"), panel9);
        ...
        this.$$$loadLabelText$$$(label10, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.plugin.update.channel"));
        ...
        this.$$$loadButtonText$$$(updateNowButton, ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.check.for.updates"));
        ...
        tabbedPane.addTab(ResourceBundle.getBundle("messages/ScalaBundle").getString("scala.project.settings.form.tabs.extensions"), panel10);
