...
import org.jetbrains.plugins.scala.lang.psi.api.statements.{ScFunction, ScVisibilityIconOwner}
...
class DottyTraitImpl private(stub: ScTemplateDefinitionStub, node: ASTNode)
  extends ScTypeDefinitionImpl(stub, ScalaElementTypes.TRAIT_DEFINITION, node) with ScClass with ScTrait with ScVisibilityIconOwner {
