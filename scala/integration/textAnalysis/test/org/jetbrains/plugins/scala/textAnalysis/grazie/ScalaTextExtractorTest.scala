...
import org.jetbrains.plugins.scala.textAnalysis.grazie.ScalaTextExtractorTest.{TripleQuote, buildTextWithSpecialMarkers}
...
class ScalaTextExtractorTest extends BasePlatformTestCase {
  ...
  private def runPerformanceTest(launchName: String)(runnable: ThrowableRunnable[?]): Unit =
