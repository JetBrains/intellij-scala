...
trait JpsSbtExtensionService {
  ...
  def getOrCreateExtension(module: JpsModule, moduleType: Option[String], displayModuleName: Option[String], externalProjectRootPath: Option[String]): JpsSbtModuleExtension
