...
/**
 * If you wish to run this test in the IDE, right-click on the class name `CompilerPluginTest_3_3`.
 ...
 *   1. In the "Build and run" section, make sure the module `scalaCommunity.compiler-plugin-3_3.test` module
