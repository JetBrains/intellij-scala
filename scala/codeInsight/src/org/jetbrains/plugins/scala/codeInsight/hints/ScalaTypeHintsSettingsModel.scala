...
class ScalaTypeHintsSettingsModel(project: Project) extends InlayProviderSettingsModel(
  ...
  override def getDescription: String = ScalaCodeInsightBundle.message("type.hints.description") + ScalaHintsSettings.xRayModeTipHtmlForSettingsDescription
  ...
  private lazy val ShowMethodResultTypeCase = new Case {
    ...
    override def description: String = ScalaCodeInsightBundle.message("method.results.description") + ScalaHintsSettings.xRayModeTipHtmlForSettingsDescription
  ...
  private lazy val ShowLocalVariableTypeCase = new Case {
    ...
    override def description: String = ScalaCodeInsightBundle.message("local.variables.description") + ScalaHintsSettings.xRayModeTipHtmlForSettingsDescription
    override def preview: String = getPreviewText
  }
  ...
  private lazy val ShowMemberVariableTypeCase = new Case {
    ...
    override def description: String = ScalaCodeInsightBundle.message("member.variables.description") + ScalaHintsSettings.xRayModeTipHtmlForSettingsDescription
    override def preview: String = getPreviewText
  }
}
