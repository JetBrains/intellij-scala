...
trait WorksheetPlainIntegrationTestBase_Scala_3_LTS_RC_AllInOne { self: PlainWorksheetTestBase =>
  @Test
  def testScala3_LTS_RC_AllInOne(): Unit = {
    val before =
      """import java.io.PrintStream
        |import scala.concurrent.duration._;
        |import scala.collection.Seq;
...
trait WorksheetPlainIntegrationTestBase_Scala_3_Next_RC_AllInOne { self: PlainWorksheetTestBase =>
  @Test
