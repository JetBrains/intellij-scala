...
class ScalaCompilingEvaluator(psiContext: PsiElement, fragment: ScalaCodeFragment)
  ...
  override def evaluate(context: EvaluationContextImpl): Value = {
    ...
    try {
      ...
      case e: Exception =>
        throw EvaluationException(DebuggerBundle.message("error.creating.evaluation.class.loader", e), e)
    }
    ...
    try {
      ...
      case e: Exception =>
        throw EvaluationException(DebuggerBundle.message("error.during.classes.definition", e), e)
    }
    ...
    try {
      ...
      case e: Exception =>
        throw EvaluationException(DebuggerBundle.message("error.during.generated.code.invocation", e), e)
    }
  }
  ...
  private def defineClasses(classes: Seq[OutputFileObject], context: EvaluationContext,
    ...
    if (classes.isEmpty) throw EvaluationException(DebuggerBundle.message("could.not.compile.generated.class"))
