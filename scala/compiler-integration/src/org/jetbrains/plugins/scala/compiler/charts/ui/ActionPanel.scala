...
class ActionPanel(setZoom: Zoom => Unit, setLevel: Level => Unit)
  ...
  private object ResetZoomAction
    extends BasicZoomAction(
      CompilerIntegrationBundle.message("compilation.charts.reset.zoom.action.text"),
      CompilerIntegrationBundle.message("compilation.charts.reset.zoom.action.description"),
  ...
  private object ZoomOutAction
    extends BasicZoomAction(
      CompilerIntegrationBundle.message("compilation.charts.zoom.out.action.text"),
      CompilerIntegrationBundle.message("compilation.charts.zoom.out.action.description"),
  ...
  private object ZoomInAction
    extends BasicZoomAction(
      CompilerIntegrationBundle.message("compilation.charts.zoom.in.action.text"),
      CompilerIntegrationBundle.message("compilation.charts.zoom.in.action.description"),
