...
class UpgradeWarningsToErrorsCompilerHighlightingTest_3_Next extends UpgradeWarningsToErrorsCompilerHighlightingTestBase(ScalaVersion.Latest.Scala_3_6)
