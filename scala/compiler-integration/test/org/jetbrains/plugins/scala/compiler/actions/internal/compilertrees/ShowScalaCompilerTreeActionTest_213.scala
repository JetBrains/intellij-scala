  ...
  def testParsePhasesAndTreesFromCompilerOutput(): Unit = {
    testCompilerPhasesAndTreesAreParsedAndDisplayed(
      ...
      Seq(
        ...
        PhaseWithTreeText("MegaPhase{firstTransform, checkReentrant, elimPackagePrefixes, cookComments, checkStatic, checkLoopingImplicits, betaReduce, inlineVals, expandSAMs, elimRepeated, refchecks}", "Tree placeholder 4"),
        PhaseWithTreeText("MegaPhase{crossVersionChecks, protectedAccessors, extmethods, uncacheGivenAliases, elimByName, hoistSuperArgs, forwardDepChecks, specializeApplyMethods, tryCatchPatterns, patternMatcher}", "Tree placeholder 5"),
